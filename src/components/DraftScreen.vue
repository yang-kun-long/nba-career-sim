...
<template>
  <section id="screen-draft" class="screen active"><div class="panel draft-panel">
    <h2>NBA 选秀之夜</h2>
    <div class="draft-info"><p>你今年{{ game.state?.draftAge }}岁，站在了NBA选秀大会的现场。</p><p>你的心跳加速，等待着命运的宣判...</p></div>
    ...
    <div v-if="game.draftResultVisible" class="draft-next"><button @click="game.afterDraft">开启 NBA 生涯</button></div>
  </div></section>
</template>
